...
public class CameraView extends FrameLayout {
    ...
    public void setMaskType(@MaskView.MaskType int maskType, final Context ctx) {
        ...
        int hintResourceId = com.baidu.ocr.ui.R.drawable.bd_ocr_hint_align_id_card;
        this.maskType = maskType;
        boolean isNeedSetImage = true;
        switch (maskType) {
            case MaskView.MASK_TYPE_ID_CARD_FRONT:
                hintResourceId = com.baidu.ocr.ui.R.drawable.bd_ocr_round_corner;
            ...
            case MaskView.MASK_TYPE_BANK_CARD:
                hintResourceId = com.baidu.ocr.ui.R.drawable.bd_ocr_hint_align_bank_card;
                break;
...
//        }
        ...
        hintViewText.setBackgroundResource(com.baidu.ocr.ui.R.drawable.bd_ocr_round_corner);
