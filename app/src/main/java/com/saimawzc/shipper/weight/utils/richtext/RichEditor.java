package com.saimawzc.shipper.weight.utils.richtext;
...
//        String testStr = "<img src=\"http://www.1honeywan.com/siba/img/20100120/ai5.jpg\" alt=\"dachshund\"  width=\"100%\">";
    ...
    public void insertVideo(String url,String alt, int width, int height) {
        exec("javascript:RE.prepareInsert();");
        exec("javascript:RE.insertVideoWH('" + url + "', '" + alt + "','" + width + "', '" + height + "');");
    }
                        ...
                        case MotionEvent.ACTION_UP:
                            ...
                            if (moveTime < 400 && (moveX < 25 && moveY < 25)) {
                                ...
                                if (mResult != null) {
                                    ...
                                    Log.e("msg","点击type"+type+"内容"+mResult.getExtra());
