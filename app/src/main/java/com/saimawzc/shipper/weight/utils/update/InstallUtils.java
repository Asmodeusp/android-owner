package com.saimawzc.shipper.weight.utils.update;
...
import com.saimawzc.shipper.weight.utils.update.http.AbsFileProgressCallback;
import com.saimawzc.shipper.weight.utils.update.http.DownloadFileUtils;
import com.saimawzc.shipper.weight.utils.update.utils.ActForResultCallback;
import com.saimawzc.shipper.weight.utils.update.utils.ActResultRequest;
import com.saimawzc.shipper.weight.utils.update.utils.MNUtils;
...
public class InstallUtils {
    ...
    public void startDownload() {
        ...
        if (TextUtils.isEmpty(filePath)) {
            filePath = MNUtils.getCachePath(mContext) +System.currentTimeMillis()+ "/update.apk";
        }
        //文件权限处理
