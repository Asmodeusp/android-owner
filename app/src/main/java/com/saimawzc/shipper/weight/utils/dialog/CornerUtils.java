...
public class CornerUtils {
    ...
    /**
     * set ListView item_role selector with corner drawable for the last position
    ...
    /**
     * set ListView item_role selector with corner drawable for the first and the last position
