 ...
 * 仿微博导航栏
 * **/
public class CaterpillarIndicator2 extends LinearLayout implements
    ...
    public CaterpillarIndicator2(Context context) {
        this(context, null);
        mcontext=context;
    }

    public CaterpillarIndicator2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mcontext=context;
        setFocusable(true);
