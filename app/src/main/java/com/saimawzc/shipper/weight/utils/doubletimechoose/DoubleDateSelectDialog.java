...
public class DoubleDateSelectDialog extends Dialog implements View.OnClickListener {
    ...
    public DoubleDateSelectDialog(Context context) {
       ...
       // mSelectStartTime = yearS + "-" + monthS + "-" + dayS;
        mSelectStartTime = hourS + ":" + minuteS ;
        mBeginTimeTv.setText(makeFormatContent(mContext.getString(R.string.begin_at), hourS + ":" + minuteS ));
       // mSelectEndTime = yearS + "-" + monthS + "-" + dayS;
        mSelectEndTime = hourS + ":" + minuteS ;
        mEndTimeTv.setText(makeFormatContent(mContext.getString(R.string.end_at), hourS + ":" + minuteS ));
    }
     ...
     */
    public DoubleDateSelectDialog(Context context, String allowedSmallestDate,
                                  String allowedBiggestDate, String defaultChooseDate) {
        super(context, R.style.PopBottomDialogStyle);
        this.mContext = context;
        this.allowedSmallestTime = allowedSmallestDate;
        this.allowedBiggestTime = allowedBiggestDate;
        ...
        //mSelectStartTime = hourS + ":" + minuteS ;
        mSelectStartTime = "00" + ":" + "00" ;
        hourS="00";
        minuteS="00";
        mBeginTimeTv.setText(makeFormatContent(mContext.getString(R.string.begin_at), hourS + ":" + minuteS ));
        //mSelectEndTime = hourS + ":" + minuteS ;
        mSelectEndTime = "23" + ":" + "59" ;
        mEndTimeTv.setText(makeFormatContent(mContext.getString(R.string.end_at), "23" + ":" + "59" ));
    }
    ...
    private void init(String date, boolean isShowHour) {
        ...
        if (!TextUtils.isEmpty(date)) {
            ...
            String currentDateStr = hour + ":" + minute ;
            Log.e("msg","这里开始初始化"+currentDateStr);
            try {
                allowedSmallestTime="00:00";
                allowedBiggestTime="23:59";
                ...
                if (currentDate.before(bt) || currentDate.after(et)) {
                    Log.e("msg","第二次开始"+currentDateStr);
...
//        Log.d("darren","month:"+month);
        ...
        // 选择器字体的大小
        int textSize = mContext.getResources().getDimensionPixelSize(R.dimen.px34dp);
