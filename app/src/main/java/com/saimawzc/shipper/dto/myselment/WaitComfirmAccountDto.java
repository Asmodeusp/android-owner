...
public class WaitComfirmAccountDto {
    ...
    public String getPlanWayBillId() {
        return planWayBillId;
    }

    public void setPlanWayBillId(String planWayBillId) {
        this.planWayBillId = planWayBillId;
    }
    ...
    public void setOverAllotWeight(String overAllotWeight) {
    ...
    public void setUnsettleNum(String unsettleNum) {
