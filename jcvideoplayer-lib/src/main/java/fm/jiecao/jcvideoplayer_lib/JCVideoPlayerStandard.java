...
//            }
    ...
    public void changeUiToNormal() {
        switch (currentScreen) {
            ...
            case SCREEN_LAYOUT_LIST:
                ...
                Log.d("msg","视频11111111111111111111111111");
                updateStartImage();
                break;
            case SCREEN_WINDOW_FULLSCREEN:
                setAllControlsVisible(View.VISIBLE, View.INVISIBLE, View.VISIBLE,
                        View.INVISIBLE, View.VISIBLE, View.VISIBLE, View.INVISIBLE);
                updateStartImage();
                Log.d("msg","视频2222222222222222222222222");
                break;
    ...
    public void changeUiToPreparingShow() {
        switch (currentScreen) {
            ...
            case SCREEN_LAYOUT_LIST:
                ...
                Log.d("msg","视频33333333333333333333333333333");
                break;
            case SCREEN_WINDOW_FULLSCREEN:
                setAllControlsVisible(View.VISIBLE, View.INVISIBLE, View.INVISIBLE,
                        View.VISIBLE, View.VISIBLE, View.VISIBLE, View.INVISIBLE);
                Log.d("msg","视频4444444444444444444444444444444444444");
                break;
            case SCREEN_WINDOW_TINY:
                break;
        }
    ...
    public void changeUiToPreparingClear() {
        switch (currentScreen) {
            ...
            case SCREEN_LAYOUT_LIST:
                setAllControlsVisible(View.VISIBLE, View.INVISIBLE, View.INVISIBLE,
                        View.VISIBLE, View.VISIBLE, View.VISIBLE, View.INVISIBLE);
                Log.d("msg","视频5555555555555555555555555555");
                break;
            case SCREEN_WINDOW_FULLSCREEN:
                setAllControlsVisible(View.VISIBLE, View.INVISIBLE, View.INVISIBLE,
                        View.VISIBLE, View.VISIBLE, View.VISIBLE, View.INVISIBLE);
                Log.d("msg","视频6666666666666666666666666666666666");
                break;
            case SCREEN_WINDOW_TINY:
                break;
        }
    ...
    public void onPrepared() {
        ...
        Log.d("msg","视频7777777777777777777777777777777");
        startDismissControlViewTimer();
    }
        ...
        switch (currentScreen) {
            ...
            case SCREEN_LAYOUT_LIST:
                setAllControlsVisible(View.VISIBLE, View.VISIBLE, View.VISIBLE,
                        View.INVISIBLE, View.INVISIBLE, View.INVISIBLE, View.INVISIBLE);
                Log.d("msg","视频8888888888888888888888888888");
                updateStartImage();
                break;
            case SCREEN_WINDOW_FULLSCREEN:
                setAllControlsVisible(View.VISIBLE, View.VISIBLE, View.VISIBLE,
                        View.INVISIBLE, View.INVISIBLE, View.INVISIBLE, View.INVISIBLE);
                updateStartImage();
                Log.d("msg","视频99999999999999999999999999999");
                break;
            case SCREEN_WINDOW_TINY:
                break;
        }
